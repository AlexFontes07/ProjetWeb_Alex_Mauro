				...
				<div class="col-md-8 contact-grid">
					<form>
                        <SELECT name="type" size="1">
                            <OPTION>Vendre
                            <OPTION>Louer
                            <OPTION>Proposer un service
                        </SELECT>


						<input type="text" value="Nom" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='Nom';}">
						<input type="text" value="Prix" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='Prix';}">
                        <textarea cols="77" rows="6" value=" " onfocus="this.value='';" onblur="if (this.value == '') {this.value = 'Message';}">Description</textarea>
